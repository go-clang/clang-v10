...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/go-clang/clang-v10)](https://pkg.go.dev/github.com/go-clang/clang-v10)
[![GitHub Workflow](https://img.shields.io/github/workflow/status/go-clang/clang-v10/Test/main?label=test&logo=github&style=flat-square)](https://github.com/go-clang/clang-v10/actions)

Native Go bindings for Clang v10 C API.

## Install/Update

```bash
CGO_LDFLAGS="-L`llvm-config --libdir`" \
  go install github.com/go-clang/clang-v10/...
```
